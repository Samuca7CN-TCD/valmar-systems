...
class Standard extends PrettyPrinterAbstract
{
    ...
    protected function pName(Nome $node): string
    {
        return $node->name;
    }

    protected function pName_FullyQualified(Nome\FullyQualified $node): string
    {
        return '\\' . $node->name;
    }

    protected function pName_Relative(Nome\Relative $node): string
    {
