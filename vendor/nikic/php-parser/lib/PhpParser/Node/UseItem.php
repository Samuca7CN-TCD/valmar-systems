...
class UseItem extends NodeAbstract
{
     ...
     */
    public int $type;
    /** @var Node\Nome Namespace, class, function or constant to alias */
    public Nome $name;
     ...
     *
     * @param Node\Nome $name Namespace/Class to alias
     * @param null|string|Identifier $alias Alias
     * @param Use_::TYPE_* $type Type of the use element (for mixed group use only)
     * @param array<string, mixed> $attributes Additional attributes
     */
    public function __construct(Node\Nome $name, $alias = null, int $type = Use_::TYPE_UNKNOWN, array $attributes = [])
    {
