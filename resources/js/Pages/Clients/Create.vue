<script setup>
    ...
    const submit = () => {
        ...
        form.transform(() => formToSend).post(route('clients.store'), {
            onSuccess: () => {
...
<template>
    ...
    <Head :title="'Novo ' + page.singular_name" />
    <AppLayout :page="page">
        <template #header>
                    ...
                    <form @submit.prevent="submit" class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="mt-2 flex items-center space-x-6">
                                        <label class="inline-flex items-center">
                                            <input type="radio" v-model="form.type" value="fisica"
                                                class="form-radio h-4 w-4 text-indigo-600">
                                            <span class="ml-2">Pessoa Física</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" v-model="form.type" value="juridica"
                                                class="form-radio h-4 w-4 text-indigo-600">
                                ...
                                <div>
                                    <label for="name" class="block text-sm font-medium text-gray-700">
                                        {{ form.type === 'fisica' ? 'Nome Completo' : 'Razão Social' }} <span
                                ...
                                <div>
                                    ...
                                    <input v-model="form.document" type="text" id="document" @input="handleCpfCnpjInput"
                        ...
                        <div class="mt-8 pt-5 border-t border-gray-200">
                            <div class="flex justify-end space-x-3">
                                ...
                                <button type="submit" class="simple-button-green" :disabled="form.processing">Salvar
                                    Cliente</button>
                            </div>
                        </div>
                    </form>
